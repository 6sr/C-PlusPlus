...
//This means odd levels should get printed from left to right and even levels should be printed from right to left. Each level 
//should be printed at a new line.
#include<iostream>
#include<string.h>
#include<cstdlib>
#include<stack>
